...
public class UserDataBase extends DataBase {
    ...
    protected static final String Arquive = "data/user/userDataBase.json";
    ...
    public static void addUserBase(String id, User userUnregisted) throws Exception{
        ...
        String newRegister = "    { \"id\": \"" + id + "\", \"nome\": \"" + userUnregisted.getName() + "\", \"email\": \"" + userUnregisted.getEmail() + "\", \"senha\": \"" + userUnregisted.getPassword() + "\", \"endereco\": \"" + userUnregisted.getAddress() +"\" }";
